## The functions are trying to calculate the matrix inverse for input square matrix:
## If the inverse has been calculated before, it will be fetched directly from the cache 
## (parent environment); otherwise it will compute the matrix inverse and store them in 
## cache under the name of 'm'.
## Author: Cindy Chen
## Date: 03/21/2015

## The following function will complete the functions of initialize the variables of m 
## and the elments of $set, $get, $setinv and $getinv.
